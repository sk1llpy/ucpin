...
@users.callback_query(F.data == 'menu__purchase')
@create_session
...
@users.callback_query(F.data.in_(["purchase__USD", "purchase__UZS"]), StateFilter(PurchaseState.balance_type))
@create_session
...
@users.callback_query(F.data.startswith("purchase__"), StateFilter(PurchaseState.package))
@create_session
...
# Counter
@users.callback_query(F.data == "plus", StateFilter(PurchaseState.verify))
...
@users.callback_query(F.data == "minus", StateFilter(PurchaseState.verify))
...
# Confirm
@users.callback_query(F.data == "purchase__confirm", StateFilter(PurchaseState.verify))
...
@users.callback_query(F.data == "purchase__yes", StateFilter(PurchaseState.second_step_verification))
@create_session
...
@users.callback_query(F.data == "purchase__no", StateFilter(PurchaseState.second_step_verification))
@create_session
